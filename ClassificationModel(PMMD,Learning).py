...
xy = np.loadtxt('training_pmmd.txt',unpack = True,dtype = 'float32')   
xy_ = np.loadtxt('training_pmmd_y.txt',unpack = True,dtype = 'float32')   
x_data = xy[0:].T   
y_data = xy_[0:].T   
  
  
txy = np.loadtxt('test_pmmd.txt',unpack = True,dtype = 'float32')   
txy_ = np.loadtxt('test_pmmd_y.txt',unpack = True,dtype = 'float32')   
tx_data = np.transpose(txy[0:])   
ty_data = np.transpose(txy_[0:])   
